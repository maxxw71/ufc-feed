...
UA='Mozilla/5.0 AppwizaMLSAvailability/1.1'
...
TEAM_ALIASES={
 ...
 'la galaxy':'LA Galaxy','los angeles football club':'Los Angeles FC','los angeles fc':'Los Angeles FC','lafc':'Los Angeles FC',
 ...
 'seattle sounders fc':'Seattle Sounders FC','seattle sounders':'Seattle Sounders FC','st louis city sc':'St. Louis City SC',
 'st louis city':'St. Louis City SC','toronto fc':'Toronto FC','vancouver whitecaps fc':'Vancouver Whitecaps FC',
...
def parse(text):
    ...
    for line in lines:
        ...
        n=norm(line)
        # Handle "Image: Team logo" without allowing it to override the next real team line.
        ...
        if m:
            ...
            rows.append({'team_reported':team,'player_name':player,'status':status,'reason':reason})
            continue
