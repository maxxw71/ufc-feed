...
def main():
    ...
    payload={
      ...
      'definition':'Current refined ACTIVE prospective portfolio only (R01V2, R02V2, R03, A02, A03, A05, A06); A04 is watch-only and excluded. Opposite-side conflict matches excluded.',
