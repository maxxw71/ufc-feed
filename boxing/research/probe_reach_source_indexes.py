...
SITES={
 ...
 'martialbot':['https://www.martialbot.com/robots.txt','https://www.martialbot.com/sitemap.xml','https://www.martialbot.com/sitemap_index.xml'],
}
...
for site,urls in SITES.items():
    ...
    for u in urls:
        try:
            ...
            for x in ls:
                low=x.lower()
                if 'sitemap' in low and x not in seen:queue.append(x)
