...
def main():
    ...
    for i,x in enumerate(items):
        a,a_country=participant(x.get('fighter_home'));b,b_country=participant(x.get('fighter_away'));date=date_iso(x.get('bout_date'))
        ...
        rows.append({
          ...
          'fighter_a_country':a_country,'fighter_b_country':b_country,
