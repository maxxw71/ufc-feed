...
def main():
    ...
    for row in d.execute("select * from bouts where source='wikipedia' and status='FINISHED' order by date,source_id"):
        r=dict(row)
    ...
    years=collections.defaultdict(collections.Counter); total=0
